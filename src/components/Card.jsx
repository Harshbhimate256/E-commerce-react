    ...
    <>
      <div className='card-container' style={{height:"120vh",width:"80%",marginLeft:"12vw",marginTop:"5vh", display:"flex",flexFlow:"row wrap"}}>
        <div className='card' style={{height:"45vh",width:"17vw",borderRadius:"10px",margin:"1vw"}}>
            <div style={{height:"30vh",width:"16vw",margin:"5px",position:"relative"}}>
                <div style={{fontFamily:"Tahoma",border:"none",fontSize:"8px",position:"absolute",left:"5px",top:"5px",width:"2.4vw",height:"1.1vw",textAlign:"center",borderRadius:"10px",background:"#99BBAD",color:"white",paddingTop:"1px"}}>New</div>
                ...
                <a href='#'>
                    ...
                    <img style={{opacity:"0"}} src='../card-shirt1(hover).jpg'/>
                </a>
